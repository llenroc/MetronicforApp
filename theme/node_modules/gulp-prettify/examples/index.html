    ...
    <body data-spy="scroll" data-target=".bs-sidebar">
        ...
        <div class="teaser ">
            <a class="teaser-content" href="">
                <span class="teaser-heading"> Assemble
                ...
                <section class="gallery">
                    <div class="row">
                        <div class="alert alert-danger">
                            <strong>No repos today :-(</strong>wait..! what's that you say?! We're in "dev" mode? Oh, then I was just kidding. </div>
                    </div>
                </section>
            </div>
        </div>
