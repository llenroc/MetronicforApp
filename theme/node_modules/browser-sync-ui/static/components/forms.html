...
<div bs-input="text">
    ...
    <input id="some-input" type="text" size="" value="" placeholder="EG: #main" /> </div>
<br/>
...
<div bs-input="text">
    ...
    <div bs-state-wrapper ng-class="[ctrl.state.classname]">
        <button type="submit" id="add-restriction" bs-button="size-small subtle-alt icon-left" ng-disabled="ctrl.state.waiting">
            <svg bs-svg-icon="" icon="circle-plus">
                <use xlink:href="#svg-circle-plus"></use>
            </svg>Add</button>
        <div bs-state-icons>
            <svg bs-svg-icon icon="circle-ok" bs-state="success inline">
                <use xlink:href="#svg-circle-ok"></use>
            </svg>
            <svg bs-svg-icon icon="circle-minus" bs-state="waiting inline" bs-anim="spin">
