...
<html>
    ...
    <body>
        <h1 id="nodeunit-header">Clone Test-Suite (Browser)</h1> Tests started:
                ...
                setTimeout((function(testName)
                {
                    try
                    {
                        ...
                        tests[testName](
                        {
                            ...
                            {
                                if (!_deepEqual(a, b)) throw new Error(JSON.stringify(a) + ' is not deep equal to ' + JSON.stringify(b))
                            },
                            done: function()
                            {
