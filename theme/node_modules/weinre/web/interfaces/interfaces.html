...
<html>
    ...
    <body>
        ...
        <div class="noprint"> show:
            <label>
                <input id="show-Idl" type="checkbox" checked="on"> IDL</label> /
            <label>
                <input id="show-JavaScript" type="checkbox" checked="on"> JavaScript</label> /
            <label>
                <input id="show-Java" type="checkbox" checked="on"> Java</label>
        </div>
        <div id="browser">
            ...
            <div id="interface-content">
                ...
                <div id="interface-body"> [ nothing selected ] </div>
            </div>
        </div>
    </body>
